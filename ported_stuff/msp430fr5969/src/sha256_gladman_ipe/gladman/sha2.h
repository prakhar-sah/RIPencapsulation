...
__attribute__((section(".ipe_code"))) VOID_RETURN sha256_compile(sha256_ctx ctx[1]);

__attribute__((section(".ipe_code"))) VOID_RETURN sha224_begin(sha224_ctx ctx[1]);
#define sha224_hash sha256_hash
__attribute__((section(".ipe_code"))) VOID_RETURN sha224_end(unsigned char hval[], sha224_ctx ctx[1]);
__attribute__((section(".ipe_code"))) VOID_RETURN sha224(unsigned char hval[], const unsigned char data[], unsigned long len);

__attribute__((section(".ipe_code"))) VOID_RETURN sha256_begin(sha256_ctx ctx[1]);
__attribute__((section(".ipe_code"))) VOID_RETURN sha256_hash(const unsigned char data[], unsigned long len, sha256_ctx ctx[1]);
__attribute__((section(".ipe_code"))) VOID_RETURN sha256_end(unsigned char hval[], sha256_ctx ctx[1]);
__attribute__((section(".ipe_code"))) VOID_RETURN sha256(unsigned char hval[], const unsigned char data[], unsigned long len, sha256_ctx cx[1]);
