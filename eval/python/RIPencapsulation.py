...
#Change ~/RIPencapsulation with the path to where your msp430 directory is located
if(benchmark == "aes"):
...
#Change ~/RIPencapsulation with the path to where your eval directory is located
...
if(indirect_load == 1):
    ...
    print("")
    sendCmdWaitReady(proc, "mw 0xf000 0xff", VERBOSE)
    sendCmdWaitReady(proc, "mw 0xf001 0x3f", VERBOSE)
    sendCmdWaitReady(proc, "dis increment_timer_count", VERBOSE)
    sendCmdWaitReady(proc, "set SR 0x0003", VERBOSE)
    sendCmdWaitReady(proc, "set SP 0x2bfc", VERBOSE)
    sendCmdWaitReady(proc, "set PC main", VERBOSE)
